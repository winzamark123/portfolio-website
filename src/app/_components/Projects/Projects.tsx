...
import SmallProject from './_components/SmallProject';
        ...
        <div className="mx-auto max-w-6xl px-6 text-gray-500">
          <div className="relative">
            <div className="relative z-10 grid grid-cols-6 gap-3">
              ...
              bg-gray-600 hover:bg-amber-400 dark:border-gray-800 dark:bg-gray-900 dark:hover:bg-amber-400 lg:col-span-2"
              >
