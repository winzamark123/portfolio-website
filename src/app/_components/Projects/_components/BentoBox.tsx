        ...
        <div className="relative border border-white">
          <div className="relative z-10 grid grid-cols-6 gap-3">
            {ProjectList.map((project) => (
              <div
                key={project.title}
                className={`relative flex overflow-hidden rounded-xl border border-gray-200 bg-white p-8 dark:border-gray-800 dark:bg-gray-900 sm:col-span-3 lg:col-span-${project.colSpan}`}
              >
                <Card>
                  <CardHeader>
              ...
              <div className="relative z-10 grid grid-cols-6 gap-3">
                <div className="relative col-span-full flex overflow-hidden rounded-xl border border-gray-200 bg-white p-8 dark:border-gray-800 dark:bg-gray-900 lg:col-span-2">
                  <div className="relative m-auto size-fit">
                    <div className="relative flex h-24 w-56 items-center">
                      <span className="mx-auto block w-fit bg-gradient-to-br from-blue-300 to-pink-600 bg-clip-text text-5xl font-semibold text-transparent dark:from-blue-400 dark:to-pink-400">
                        100%
                      </span>
                    </div>
                ...
                <div className="relative col-span-full overflow-hidden rounded-xl border border-gray-200 bg-white p-8 dark:border-gray-800 dark:bg-gray-900 lg:col-span-3">
                  <div className="grid h-full sm:grid-cols-2">
                    ...
                    <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-gray-200 dark:before:bg-gray-800 sm:-my-8 sm:-mr-[--card-padding]">
                ...
                <div className="relative col-span-full flex overflow-hidden rounded-xl border border-gray-200 bg-white p-8 dark:border-gray-800 dark:bg-gray-900 lg:col-span-4">
                  <div className="relative m-auto size-fit">
                    <div className="relative flex h-24 w-56 items-center">
                      <span className="mx-auto block w-fit bg-gradient-to-br from-blue-300 to-pink-600 bg-clip-text text-5xl font-semibold text-transparent dark:from-blue-400 dark:to-pink-400">
                        100%
